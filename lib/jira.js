...
(function() {
    ...
    this.searchJira = function(searchString, startAt, nbResult, callback) {
        // backwards compatibility
        var options = {
            rejectUnauthorized: this.strictSSL,
            uri: this.makeUri('/search?jql='+searchString+'&startAt='+startAt+'&maxResults='+nbResult),
            method: 'GET'
        };
    ...
    this.searchUser = function(username, callback) {
        var options = {
          rejectUnauthorized: this.strictSSL,
          uri: this.makeUri('/user?username='+username),
          method: 'GET'
        };
